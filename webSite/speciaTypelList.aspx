<%@ Page Language="C#" AutoEventWireup="true" CodeFile="speciaTypelList.aspx.cs" Inherits="speciaTypelList" %>
...
<section  class="container features">
  ...
  <tr>
    ...
    <td width="84%" class="top2lki_title"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="3" class="top21tt"><p  style="text-align:center"><asp:Label ID="noDataTip" runat="server"></asp:Label></p>
           <ul class="imglist"> 
              <asp:Repeater ID="rptNews" runat="server" >
                     <ItemTemplate>           
                    <li>
                        <a href="class.aspx?TypeId=<%#Eval("ID").ToString()%>&ToolTip=<%#Eval("cTypeName").ToString()%>">
                            <img src="/uploads/SpecialImg/<%#Eval("cPic").ToString()%>" />
