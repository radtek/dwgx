<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Info.aspx.cs" Inherits="Detaile" %>
...
<td colspan="3" class="top3lk_ohter1">当前位置：<a href="index.aspx">网站首页</a> > <%=Request.QueryString["ToolTip"]%></td>
  ...
  <!--  
  <tr>
    <th width="8%" scope="row" class="auto-style1"></th>
    <td width="84%" class="auto-style2" id="infoTitle" runat="server">优化资源合理布局推动园区更好发展</td>
    <td width="8%" class="auto-style1"></td>
  </tr>-->
       <!--
  <tr >
    <th scope="row">&nbsp;</th>
    <td class="top2lk_ohter">来源：采写/沈文利     责任编辑：Admin    发布日期：2017/3/10 9:46:58</td>
    <td>&nbsp;</td>
  </tr>
       -->
  <tr>
    <th scope="row">&nbsp;</th>
    <td class="top2lk_conter">
      <div id="infoContent" runat="server">区公共资产管理中心主要任务是受区管委会委托，负责统一运营、管理、调配和处置区属行政事业单位土地资产、实物资产、垄断或特许经营类资产（资源）和区内其他公共资产（资源）；根据区管委会授权，履行区属经营实体的出资人职责；承担上级交办的其他工作。内设综合部、企业管理部、资产管理部3个部门。</div>
      </td>
    <td>&nbsp;</td>
  </tr>
