<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoteData_Edit.aspx.cs" Inherits="Manage_VoteData_Edit" %>
                                ...
                                <tr>
                                  <td>
                                      <table width=100% border=0>
                                          <tr>
                                              <td>
                                                  <asp:Label ID="myTitle" runat="server" Font-Bold="True" Text="添加投票"></asp:Label>
                                              </td>
                                              <td>
                                              </td>
                                              <td align="right">
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              <tr>
                                  <td colspan="1" rowspan="1" bgColor="#f8f8f8">
                                      投票名称：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="cTitle" runat="server" MaxLength="25" Width="250px"></asp:TextBox>
                                      &nbsp;*（请填写名称）</td>
                                  <td bgcolor="#ffffff" align="center" rowspan="4">
                                      &nbsp;</td>
                              </tr>
                              <tr>
                                  <td colspan="1" bgColor="#f8f8f8">
                                      投票次数：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="iCount" runat="server" MaxLength="25" Width="142px">0</asp:TextBox>
                                      </td>
                              </tr>
                              ...
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff" style="height: 21px">
                                      ...
                                      <input onclick="location.href='VoteData_List.aspx?VID=<%=Request.QueryString["VID"] %>';" type="button" value="返回" /></td>
                              </tr>
                          </table>
