<%@ Page Language="C#" AutoEventWireup="true" CodeFile="specialTypeEdit.aspx.cs" Inherits="Manage_specialTypeEdit" %>
                      ...
                      <td>
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              ...
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff" style="height: 21px">
                                      <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text=" 编辑 " OnClientClick="" />&nbsp;
