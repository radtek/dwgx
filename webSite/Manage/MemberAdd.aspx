                      ...
                      <td>
                        <table width="90" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td align="center" background="images/index1_36.gif"><a href="#" class="font3"><strong>添加用户</strong></a></td>
                    ...
                    <tr>
                      <td>
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              ...
                              <tr>
                                  <td bgcolor="#ffffff" height=26 colspan="2">
                                  
                                  <table id="Table1" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                                      <tr>
                                      ...
                                      <ItemTemplate>
                                       <tr>
                                          <td bgcolor="#ffffff">
                                             <%#Eval("cTypeName").ToString()%></td></td>
                                          <td bgcolor="#ffffff">
                                           <asp:CheckBox ID="myCheck" runat="server" Text="选择" dataID='<%#Eval("ID")%>' />
                                          </td>
                                      </tr>
                                      </ItemTemplate>
                                      </asp:Repeater>
                                      ...
                                      <ItemTemplate>
                                       <tr>
                                          <td bgcolor="#ffffff">
                                              <%#Eval("cMemo").ToString()%></td>
                                          <td bgcolor="#ffffff">
                                          
                                           <asp:CheckBox ID="myInfoCheck" runat="server" Text="选择" dataID='<%#Eval("ID")%>' />
                              ...
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff" style="height: 21px">
                                      <asp:Button ID="Button1" runat="server" OnClick="btnSave_Click" Text=" 添加 " />&nbsp;
