...
<body style="text-align: center">
    ...
    <table style="width: 400px; height:247px; font-size: 9pt;" border="0" cellpadding="0" cellspacing="0" align="center"  background ="../Images/logo0.gif" >
    <tr>
    ...
    <table style="width: 256px; height:86px; font-size: 9pt;" border="0" cellpadding="0" cellspacing="0" align="center" >
            ...
            <tr>
                <td colspan="3" style="text-align: center; height: 29px;" align =center >
                    ...
                    &nbsp;<asp:Button ID="btnLogin" runat="server" Text="登录" OnClick="btnLogin_Click" style="height: 21px"/>
                    &nbsp;&nbsp;
