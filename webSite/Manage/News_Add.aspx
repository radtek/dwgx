<%@ Page Language="C#" AutoEventWireup="true" CodeFile="News_Add.aspx.cs" Inherits="Manage_News_Add" %>
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              ...
                              <tr>
                                  <td bgcolor="#ffffff">
                                      来&nbsp;&nbsp;&nbsp; 源：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="cLittleTitle" runat="server" MaxLength="100" Width="151px"></asp:TextBox>
                                      &nbsp; （100字内）</td>
                              </tr>
                              <tr>
                                  <td bgcolor="#ffffff">
                              ...
                              <tr style="display:">
                                  <td bgcolor="#ffffff">
                                      视频新闻图片：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:FileUpload ID="upLoadVideoImg" runat="server" Width="330px" Height="19px" />（支持JPG、PNG或GIF格式图片）
                                  </td>
                              </tr>
                              <%} %>
                              ...
                              <tr style="display:">
                                  ...
                                  <td bgcolor="#ffffff">
                                      ...
                                      <asp:FileUpload ID="FileUpload3" runat="server" Width="320px" Height="19px" />（支持JPG、PNG或GIF格式图片）
                                  </td>
                              </tr>
...
&nbsp;（支持MP4、SWF、OGG或FLV格式）</td>
    ...
    </form>  <OBJECT id="dlgHelper"  height="0px" width="0px" classid="clsid:3050f819-98b5-11cf-bb82-00aa00bdce0b">
			</OBJECT>
</body>
</html>
