<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vote_Edit.aspx.cs" Inherits="Manage_Vote_Edit" %>
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff">
                                      ...
                                      <asp:ListItem Value="单选">单选</asp:ListItem>
                              ...
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff" style="height: 21px">
                                      ...
                                      <input onclick="location.href='Vote.aspx';" type="button" value="返回" /></td>
                              </tr>
                          </table>
