<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vote.aspx.cs" Inherits="Manage_Vote" %>
                    ...
                    <tr>
                      <td>
                          ...
                          <ItemTemplate>  <tr>
                            ...
                            <td  class="Table_BG<%# Container.ItemIndex % 2 %>" ><a href="Vote_Edit.aspx?ID=<%#Eval("ID").ToString() %>"><%# Eval("cTitle")%></a></td>
                             <td  class="Table_BG<%# Container.ItemIndex % 2 %>" ><%#Eval("cType").ToString() %></td>
                                <td  class="Table_BG<%# Container.ItemIndex % 2 %>" ><%#Eval("dCreateTime").ToString() %></td>
                              <td  class="Table_BG<%# Container.ItemIndex % 2 %>" >
                               <input onclick="location.href='VoteData_List.aspx?VID=<%#Eval("ID") %>';"
                                  style="height: 20px" type="button" value="内容管理" /> 
                              |
                              <input onclick="location.href='Vote_Edit.aspx?pAct=edit&ID=<%#Eval("ID").ToString() %>';"
