<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Info_Edit.aspx.cs" Inherits="Manage_Info_Edit" %>
                          ...
                          <tr>
                            <td>
                              <table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF">
                                <tr>
                                  <td align="center">
                                      <asp:Label ID="cTitle" runat="server" Text="Label" Font-Bold="True"></asp:Label>
                                  </td>
                                </tr>
                              </table>
                            </td>
