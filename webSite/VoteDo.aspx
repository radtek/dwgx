<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoteDo.aspx.cs" Inherits="VoteDo" %>
...
<section  class="container features">
  ...
  <tr>
    ...
    <td width="84%" class="top2lki_title"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="3" class="top21tt"><table width="99%" border="0" cellspacing="0" cellpadding="0" >
           <asp:Repeater ID="rptVoteData" runat=server >
                          <HeaderTemplate><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#BBD3EB">
                          <tr>
                            <td height="27" align="center" background="images/index1_72.gif">
                              <label>
                              请选择
                              </label>
                            </td>
                          ...
                          <ItemTemplate>  <tr>
                            <td height="26" align="center" >
                              ...
                              <% if (voteType == 0) {%>
                                 <input type="radio" name="checkbox" value="<%#Eval("ID").ToString() %>" />
                              <%} else {%>
                            ...
                            <td   <%# Container.ItemIndex % 2 %>" align="center" ><%# Eval("cName")%></td>
                          </tr></ItemTemplate>
                          <FooterTemplate>                            
...
<script type="text/javascript">
        ...
        //查找
        function FindData() {
            location.href = "./class.aspx?seekStr=" + $("#findText").val();
