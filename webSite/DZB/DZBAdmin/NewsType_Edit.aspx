<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsType_Edit.aspx.cs" Inherits="DZBAdmin_NewsType_Edit" %>
                                ...
                                <tr>
                                  <td>
                                      <table width=100% border=0>
                                          <tr>
                                              <td>
                                                  <asp:Label ID="cTitle" runat="server" Font-Bold="True" Text="添加版面"></asp:Label>
                                              </td>
                                              <td>
                                              </td>
                                              <td align="right">
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              <tr>
                                  <td colspan="1" bgColor="#f8f8f8">
                                      所属期刊：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:DropDownList ID="myNewsClassList" runat="server">
                                      <asp:ListItem Value="">请选择</asp:ListItem>
                                      </asp:DropDownList>
                                  </td>
                                  <td bgcolor="#ffffff" align="center" rowspan="5">
                                      <asp:Literal ID="cPic" runat="server"></asp:Literal>
                                  </td>
                              </tr>
                              <tr>
                                  <td colspan="1" rowspan="1" bgColor="#f8f8f8">
                                      版面名称：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="cTypeName" runat="server" MaxLength="25" Width="250px"></asp:TextBox>
                                      &nbsp;*（请填写版面名称，如：A版）</td>
                              </tr>
                              <tr>
                                  <td bgcolor="#f8f8f8">
                              ...
                              <tr id="myCreateTimeTr" runat=server >
                                  <td bgcolor="#f8f8f8" height="28">
                                      创建时间：</td>
                                  <td bgcolor="#ffffff">
                              ...
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff" style="height: 21px">
                                      <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text=" 添加 " OnClientClick="" />&nbsp;
                                      <input onclick="location.href='NewsType_List.aspx?CID=<%=myChar.RequestQueryString("CID")%>&ID=<%=myChar.RequestQueryString("ID")%>';" type="button" value="返回" /></td>
                              </tr>
                          </table>
