<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pass_Change.aspx.cs" Inherits="LDAdmin_Pass_Change" %>
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              ...
                              <tr>
                                  <td bgcolor="#ffffff" colspan="1" rowspan="1" style="height: 22px">
                                      旧 密 码：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="cOldPass" runat="server" MaxLength="25" Width="225px"></asp:TextBox>
                                      *（25字内）</td>
                              </tr>
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="cNewPass" runat="server" MaxLength="25" Width="225px"></asp:TextBox>
                                      *（25字内）</td>
                              </tr>
                              <tr>
                                  <td bgcolor="#ffffff" style="height: 22px">
