<%@ page language="C#" autoeventwireup="true" inherits="LDAdmin_User_List_Add, App_Web_lekpraw3" %>
                                  ...
                                  <table id="Table1" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                                      ...
                                      <ItemTemplate>
                                       <tr>
                                          ...
                                          <td bgcolor="#ffffff">
                                           <input id="News_T<%#Eval("ID").ToString()%>" type="checkbox" name="News_T<%#Eval("ID").ToString()%>" /><label for="News_T<%#Eval("ID").ToString()%>">选择</label>
                                          </td>
                                      </tr>
                                      </ItemTemplate>
                                      </asp:Repeater>
