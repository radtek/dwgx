<%@ page language="C#" autoeventwireup="true" inherits="DZBAdmin_NewsClass_Edit, App_Web_lekpraw3" %>
                                ...
                                <tr>
                                  <td>
                                      <table width=100% border=0>
                                          <tr>
                                              <td>
                                                  <asp:Label ID="cTitle" runat="server" Font-Bold="True" Text="添加期刊"></asp:Label>
                                              </td>
                                              <td>
                                              </td>
                                              <td align="right">
                          ...
                          <table id="Table3" bgcolor="#C4E7FB" border="0" cellpadding="4" cellspacing="1" width="100%">
                              <tr>
                                  <td colspan="1" rowspan="1" bgColor="#f8f8f8">
                                      期刊名称：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="cClassName" runat="server" MaxLength="25" Width="225px"></asp:TextBox>
                                      &nbsp;*（请填写期数名称，如：20130505期）</td>
                              </tr>
                              <tr>
                                  <td bgcolor="#f8f8f8">
                                      出版日期：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:TextBox ID="dOutTime" runat="server" MaxLength="25" Width="225px"></asp:TextBox>
                                      &nbsp;*（格式：2013-5-5）</td>
                              </tr>
                              <tr id="myCreateTimeTr" runat=server style="display:none">
                                  <td bgcolor="#f8f8f8" height="28">
                                      创建时间：</td>
                                  <td bgcolor="#ffffff">
                                      <asp:Literal ID="dCreateTime" runat="server"></asp:Literal>
                                  </td>
                              </tr>
                              <tr>
                                  ...
                                  <td bgcolor="#ffffff" style="height: 21px">
                                      ...
                                      <input onclick="location.href='NewsClass_List.aspx';" type="button" value="返回" /></td>
                              </tr>
                          </table>
