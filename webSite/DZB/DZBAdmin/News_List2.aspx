<%@ Page Language="C#" AutoEventWireup="true" CodeFile="News_List2.aspx.cs" Inherits="LDAdmin_News_List2" %>
                                  ...
                                  <td>
                                      <table width=100% border=0>
                                          <tr>
                                              ...
                                              <a href="News_Add2.aspx?CId=<%=myChar.RequestQueryString("CID") %>&TId=<%=myChar.RequestQueryString("TypeID") %>&Name=<%=myChar.RequestQueryString("Name") %>"><img src="images/BTN_News_Add2.jpg"  border="0" alt="添加新闻" id="IMG1" /></a></td>
                                              
                                              
                                                  <td style="width: 113px">
                                                  <asp:ImageButton ID="ImageButton2" ImageUrl="images/BTN_News_Delete2.jpg" runat="server" OnClick="ImageButton2_Click" ToolTip="删除新闻" /></td>
                      ...
                      <td>
                          ...
                          <ItemTemplate>      <tr>
                            ...
                            <td  class="Table_BG<%# Container.ItemIndex % 2 %>" ><%#Eval("dCreateTime").ToString() %></td>
                              ...
                              <input type=button value="编辑" onclick="location.href='News_Edit2.aspx?Id=<%#Eval("ID").ToString() %>&CId=<%=myChar.RequestQueryString("CId") %>&TId=<%=myChar.RequestQueryString("TYPEID") %>&Name=<%=myChar.RequestQueryString("Name") %>';"  style=" height:20px" /> 
                              </td>
                          </tr></ItemTemplate>
                          <FooterTemplate> 
