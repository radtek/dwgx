...
//-->
                  ...
                  <ItemTemplate><tr><td width="10"><img src="images/dot2.gif" align="absmiddle" /></td><td><a href="News_View.aspx?id=<%#Eval("id").ToString() %>" target=_blank class=Font_14><%#myChar.getStrLength(Eval("cTitle").ToString(),22) %></a></td></tr></ItemTemplate>
