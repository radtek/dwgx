<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoteList.aspx.cs" Inherits="VoteL" %>
      ...
      <tr>
        <td colspan="3" class="top21tt"><p  style="text-align:center"><asp:Label ID="noDataTip" runat="server"></asp:Label></p><table width="99%" border="0" cellspacing="0" cellpadding="0" >
           <asp:Repeater ID="rptVote" runat="server" >
              <ItemTemplate>
                 <tr>
                    <td><img src="img/arrow_small_black.gif" width="10" height="10"><a href="VoteDo.aspx?id=<%#Eval("ID").ToString()%>"><%#CommonClass.GetString(Eval("cTitle").ToString(),150,"...")%></a> </td>
