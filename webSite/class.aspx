...
<section  class="container features">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
    <td colspan="3" class="top3lk_ohter1">当前位置：<a href="index.aspx">网站首页</a> > <%=Request.QueryString["ToolTip"]%></td>
  </tr>
  <tr>
    <th width="8%" scope="row">&nbsp;</th>
    <td width="84%" class="top2lki_title"><table width="100%" border="0" cellspacing="0" cellpadding="0">


      <tr>
        <td colspan="3" class="top21tt"><p  style="text-align:center"><asp:Label ID="noDataTip" runat="server"></asp:Label></p> <table width="99%" border="0" cellspacing="0" cellpadding="0" >
            
            <%if (string.IsNullOrEmpty(reqSeekTitle) && int.Parse(reqTypeId) == 45)
                { %>
                <ul class="imglist"> 
            <%} %>
            ...
            <asp:Repeater ID="rptNews" runat="server" >           
                <ItemTemplate>   
                    <%if (string.IsNullOrEmpty(reqSeekTitle) == false || int.Parse(reqTypeId) != 45) { %>
                        <tr>
                           <td><img src="img/arrow_small_black.gif" width="10" height="10"><a target="_blank" href="NewDetail.aspx?id=<%#Eval("ID").ToString()%>"><%#CommonClass.GetString(Eval("cTitle").ToString(),103,"...")%></a> </td>
                    ...
                    { %> 
                        <li>
                            <a target="_blank" href="NewDetail.aspx?id=<%#Eval("ID").ToString()%>">
                               <img src="/uploads/videoImg/<%# string.IsNullOrEmpty(Eval("cPutPicPath").ToString())?"defVideoImg.jpg":Eval("cPutPicPath").ToString()%>" />
                               <span><%#Eval("cTitle").ToString()%></span>
                            </a>
                        </li> 
                    <%} %>
  ...
  <%if (recordCount > pageSize)
      {%>
   <tr><td></td><td> <table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#FDFDFF">
                                <br/>
                                <tr>
