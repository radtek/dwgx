<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewDetail.aspx.cs" Inherits="NewDetail" %>
...
<section  class="container features">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
         <td colspan="3" class="top3lk_ohter1">当前位置：<a href="index.aspx">网站首页</a> > <asp:Label ID="navTitle" runat="server"></asp:Label></td>
  </tr>

  <tr>
    <th width="8%" scope="row" class="auto-style1"></th>
    <td width="84%" class="auto-style2" id="newTitle" runat="server"></td>
    ...
    <td class="top2lk_conter">
       ...
       <div id="a1" style="text-align:center">
             <video width="600" height="400" controls="controls">
              <source src="uploads/Video/<%=videoPath%>" type="video/mp4">
