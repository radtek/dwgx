...
<table style="font-size: 10pt; color: #000099; margin-top: 0px; padding-top: 0px; width: 778px; height:216px" border="0" cellspacing="0"  background ="Images/新闻发布系统首页1.jpg">
    ...
    <tr style ="width :778px; height :27px" >
        <td align="right" colspan="11" >
            <asp:Label ID="Label1" runat="server" BackColor="White" ForeColor="#404040" Text="输入关键字："></asp:Label>
    ...
    <td colspan="11" style="height: 142px"></td>
    </tr>
